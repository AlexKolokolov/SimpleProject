...
5. Register custom data types. Query set from file register_types.sql
6. Compile packages from files constants.pck, dep_manage.pck and emp_manage.pck
7. Next time run project on server with hibernate.hbm2ddl.auto=update parameter in aplicationContext.xml.